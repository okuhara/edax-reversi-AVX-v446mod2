# edax-reversi-AVX-v449mod2
Backport edax-reversi-AVX 4.5.1 optimizations those do not affect fingerprint (search node count) onto the v446mod2.
Solves endgames 15-40% faster than the v446mod2.
